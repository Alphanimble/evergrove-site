					...
					>
						<div className="bg-card rounded-2xl p-2 shadow-lg">
							<button
								...
								className={`px-8 py-4 rounded-xl font-semibold transition-all duration-300 ${activeTab === "layouts"
							...
							<button
								...
								className={`px-8 py-4 rounded-xl font-semibold transition-all duration-300 ${activeTab === "clubhouses"
									? "bg-primary text-white shadow-lg"
									: "text-muted-foreground hover:text-foreground"
									}`}
							>
